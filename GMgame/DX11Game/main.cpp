...
#define WINDOW_NAME		_T("Pierce the balloon")	// ウインドウのキャプション名
...
HRESULT Init(HWND hWnd, BOOL bWindow)
{
	...
	hr = D3D11CreateDeviceAndSwapChain(nullptr, D3D_DRIVER_TYPE_HARDWARE,
		nullptr, D3D11_CREATE_DEVICE_BGRA_SUPPORT, featureLevels, _countof(featureLevels), D3D11_SDK_VERSION, &scd,
...
void StartSceneChange(E_TYPE_SCENE next)
{
	...
	switch (g_currentScene)
	{
	case SCENE_TITLE:UninitSceneTitle();
		break;
