...
// マクロ定義
#define	NUM_MPARTS_MENU		(6)			// ポーズメニュー数
...
#define	MPARTS_MENU_POS_Y	(250.0f)	// ポーズメニュー位置(Y座標)
...
static LPCWSTR c_aFileNameMPartsMenu[NUM_MPARTS_MENU] =
{
	...
	L"data/TEXTURE/tori2.png",	// リトライ
	L"data/TEXTURE/buta2.png",	// リトライ
	L"data/TEXTURE/usi2.png",	// リトライ
};
...
void UpdateMParts(void)
{
	...
	XMFLOAT2 pos4 = XMFLOAT2(MPARTS_MENU_POS_X + 1 * MPARTS_MENU_INTERVAL, MPARTS_MENU_POS_Y - 1 * 250);
	XMFLOAT2 pos5 = XMFLOAT2(MPARTS_MENU_POS_X, MPARTS_MENU_POS_Y - 2 * 250);
	XMFLOAT2 pos6 = XMFLOAT2(MPARTS_MENU_POS_X + 1 * MPARTS_MENU_INTERVAL, MPARTS_MENU_POS_Y - 2 * 250);
